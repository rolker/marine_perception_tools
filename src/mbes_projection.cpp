...
const char * offline_projection_caveat()
{
  return
    ...
    "falls below 4 m² and CUBE spreads each sounding over an influence radius "
    "of about 5 m — the same assumption the live boat, import_bag, "
    "batch_regen_bag and bag_to_geotiff all run, so this lab agrees with the "
    "store rather than inventing a tighter number; (2) lever arms are zero and "
